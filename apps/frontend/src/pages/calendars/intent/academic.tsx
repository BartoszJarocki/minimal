...
const INTENT: PSEOIntent = "academic";
...
export default function AcademicCalendarPage({ content, currentYear }: Props) {
  const url = "https://useminimal.com/calendars/intent/academic";
