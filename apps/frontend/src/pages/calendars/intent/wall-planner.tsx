...
const INTENT: PSEOIntent = "wall-planner";
...
export default function WallPlannerPage({ content, currentYear }: Props) {
  const url = "https://useminimal.com/calendars/intent/wall-planner";
      ...
      <Container>
        <main className="pb-24">
          ...
          <section className="mt-12 px-2">
            <H2>Preview</H2>
            <div className="mt-4">
              <ScaledPreview format="a4" variant="landscape">
