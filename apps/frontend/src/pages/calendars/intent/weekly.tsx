...
const INTENT: PSEOIntent = "weekly";
...
export default function WeeklyCalendarPage({ content, currentYear }: Props) {
  const url = "https://useminimal.com/calendars/intent/weekly";
