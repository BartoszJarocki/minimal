...
import { SimpleMonthCalendar } from "../../../components/calendar/themes/Simple";
...
const INTENT: PSEOIntent = "monthly";
...
export default function MonthlyCalendarPage({ content, currentYear }: Props) {
  const url = "https://useminimal.com/calendars/intent/monthly";
