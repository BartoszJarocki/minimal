      ...
      () => ({
        ...
        letter: {
          portrait: {
            ...
            yearHeader:
              "text-vertical-rl mb-6 ml-auto basis-[30%] translate-x-24 rotate-180 self-end text-end text-[120px] font-semibold leading-none tracking-tighter",
            monthHeader:
              "flex items-center px-1 text-xl font-semibold leading-none tracking-tighter",
            monthsGrid: "grid grid-cols-2 gap-2",
            dayCell:
              "flex items-center justify-center text-center text-[10px] leading-none tracking-tighter",
          },
          landscape: {
            root: "flex flex-col p-10 text-foreground",
            yearRoot: "",
            yearHeader:
              "mb-4 ml-auto self-end text-end text-[72px] font-semibold leading-none tracking-tighter",
            monthHeader:
              "flex items-center px-1 text-xl font-semibold leading-tight tracking-tighter",
            monthsGrid: "grid grid-cols-4 gap-3",
            dayCell: "flex items-center justify-center text-center text-[11px]",
          },
        },
      }),
      []
      ...
      () => ({
        a4: {
          portrait: {
            ...
            monthName:
              "text-[112px] font-semibold leading-normal tracking-tighter",
            yearName:
              "text-2xl leading-none tracking-tighter opacity-50 text-end",
          ...
          landscape: {
            root: "flex h-full w-full flex-col p-12",
            monthName:
              "text-[64px] font-semibold leading-normal tracking-tighter",
            yearName:
              "text-2xl leading-none tracking-tighter opacity-50 text-end",
            day: "flex p-3 text-center items-center justify-center",
            month: "py-6 text-xl",
        ...
        a5: {
          portrait: {
            ...
            monthName:
              "text-[89px] font-semibold leading-none tracking-tighter",
            yearName:
              "text-xl leading-none tracking-tighter opacity-50 text-end",
          ...
          landscape: {
            ...
            monthName:
              "text-[44px] font-semibold leading-none tracking-tighter",
            yearName:
              "text-lg leading-none tracking-tighter opacity-50 text-end",
        ...
        letter: {
          portrait: {
            root: "flex h-full w-full flex-col p-10",
            monthName:
              "text-[96px] font-semibold leading-normal tracking-tighter",
            yearName:
              "text-xl leading-none tracking-tighter opacity-50 text-end",
            day: "flex p-2 text-center items-center justify-center",
            month: "pb-4 text-lg",
          ...
          landscape: {
            root: "flex h-full w-full flex-col p-10",
            monthName:
              "text-[56px] font-semibold leading-normal tracking-tighter",
            yearName:
              "text-xl leading-none tracking-tighter opacity-50 text-end",
            day: "flex p-2 text-center items-center justify-center",
            month: "py-4 text-lg",
